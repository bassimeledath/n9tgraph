// Renders all .n9 files in examples/benchmark3/ to SVG and PNG
...
const BENCHMARK_DIR = join(import.meta.dirname ?? '.', '..', 'examples', 'benchmark3');
const OUTPUT_DIR = join(BENCHMARK_DIR, 'output');
const DOWNLOADS_DIR = join(process.env.HOME ?? '~', 'Downloads', 'n9tgraph-benchmark3');

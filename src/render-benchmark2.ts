// Renders all .n9 files in examples/benchmark2/ to SVG and PNG
...
const BENCHMARK_DIR = join(import.meta.dirname ?? '.', '..', 'examples', 'benchmark2');
const OUTPUT_DIR = join(BENCHMARK_DIR, 'output');
const DOWNLOADS_DIR = join(process.env.HOME ?? '~', 'Downloads', 'n9tgraph-benchmark2');
